                            ...
                            <table class="table table-striped table-bordered" id="datatable-buttons" style="width:100%">
                                ...
                                @foreach($contens as $conten)
                                    <tr class="even gradeC" align="center">
                                        ...
                                        <td>
                                            @if($conten->status == 0)
                                                <a href="{{route('unactive.content',$conten->id)}}"><img height="45px" src="https://file.removal.ai/preview/tmp-641d3b4f00ec4.png"> </a>
                                            @elseif($conten->status == 1)
                                                <a href="{{route('active.content',$conten->id)}}"><img height="30px" src="https://file.removal.ai/preview/tmp-641d38b7d6021.png"></a>
                                            @endif
                                        </td>
                                        <td>
