    ...
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li><a><i class="fa fa-edit"></i> Post <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="{{route('admin.post.index')}}">List Post</a></li>
        ...
        <ul class="nav side-menu">
            <li><a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-images" viewBox="0 0 16 16">
                ...
                <ul class="nav child_menu">
                    <li><a href="{{route('admin.slide.index')}}">List Slide</a></li>
        ...
        <ul class="nav side-menu">
            <li><a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-menu-button-wide" viewBox="0 0 16 16">
                    ...
                    </svg>&nbsp; Content Banner <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="{{route('admin.content.index')}}">List Content</a></li>
        ...
        <ul class="nav side-menu">
            <li><a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-right-text-fill" viewBox="0 0 16 16">
                    ...
                    </svg> &nbsp; Contact <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="{{route('admin.contact.index')}}">List Contact</a></li>
                </ul>
            </li>
        </ul>
        <ul class="nav side-menu">
            <li><a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-heading" viewBox="0 0 16 16">
                    ...
                    </svg> &nbsp;  Comment <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li>
        ...
        <ul class="nav side-menu">
            <li><a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
                    ...
                    </svg> &nbsp;  Account <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li>
                        <a href="{{route('users.index')}}">List Account</a>
                    </li>
                    <li>
        ...
        <ul class="nav side-menu">
            <li><a><i class="fa fa-bar-chart-o"></i>Statistical<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li>
                        <a href="{{route('admin.comment.index')}}">List Statistical</a>
                    </li>
                </ul>
            </li>
        </ul>
